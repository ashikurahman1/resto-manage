      ...
      <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
        ...
        <div className="no-scrollbar flex w-full items-center gap-3 overflow-x-auto pb-2 md:w-auto md:pb-0">
          <div className="relative min-w-[160px]">
            <select className="w-full cursor-pointer appearance-none rounded-lg border-0 bg-base-200 py-3 pl-4 pr-10 text-sm font-medium text-base-content focus:ring-2 focus:ring-primary/50">
